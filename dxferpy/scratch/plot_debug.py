...
for i, contour in enumerate(contours):
    if cv2.contourArea(contour) > 10000:
        ...
        plt.plot(pts[:, 0], pts[:, 1], 'g.-', label='Original DP')
        plt.plot(refined[:, 0], refined[:, 1], 'r.-', label='Refined V7')
        plt.gca().invert_yaxis()
        plt.legend()
        plt.savefig("/home/aledawizard/.gemini/antigravity/brain/13e2c01f-bc24-44bb-9f2a-47de4ccf7434/plot_phone_case.png")
        break
