...
def process_image(img_path, session):
    ...
    if corners is not None:
        ...
        print(f"Could not find 4 ArUco markers in {img_path}, processing original image.")
        warped = img

    # Use BiRefNet to get the perfect mask (including holes!)
    ...
    # Create and save an outline for vectorization (DXF)
